...
import lbx.qrcode.google.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(IQrCodeCallback callback, QrManager manager, Vector<BarcodeFormat> decodeFormats,
                                  String characterSet) {
        this.callback = callback;
        this.manager = manager;
        decodeThread = new DecodeThread(callback, this, decodeFormats, characterSet,
    ...
    public void handleMessage(Message message) {
        ...
        if (what == R.id.auto_focus) {
            ...
            manager.handleDecode((Result) message.obj, barcode);
            ...
            callback.setResult(Activity.RESULT_OK, (Intent) message.obj);
            callback.finish();
    ...
    private void restartPreviewAndDecode() {
        if (state == State.SUCCESS) {
            ...
            CameraManager.getInstance().requestPreviewFrame(decodeThread.getHandler(), R.id.decode);
            CameraManager.getInstance().requestAutoFocus(this, R.id.auto_focus);
            ViewfinderView viewfinderView = callback.getViewfinderView();
